...
function RightSidebar() {
  ...
  <div style={{ position: 'relative', display: 'inline-block' }}>
    <img
      src="https://imgs.search.brave.com/eeX_MK9H_y_4cRt8sUkSNLOihplwdvapjYn0bP18AqA/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly9idWZm/ZXIuY29tL2xpYnJh/cnkvY29udGVudC9p/bWFnZXMvMjAyMi8w/My9za2l0Y2gtLTct/LnBuZw"
      alt="Image 1"
      className="circle-image"
    />
    <div className="plus-icon" style={{ position: 'absolute', bottom: '5px', right: '5px' }}>
      <FontAwesomeIcon icon={faPlus} size="sm" style={{ color: '#fff', background: '#007bff', borderRadius: '50%', padding: '2px' }} />
    </div>
  </div>
  <img src="https://imgs.search.brave.com/Y3pO8-C92CX1StfQWkDj40a0Oxak3lfbywlZqG8l4dY/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly9kNW51/bnlhZ2NpY2d5LmNs/b3VkZnJvbnQubmV0/L2V4dGVybmFsX2Fz/c2V0cy9oZXJvX2V4/YW1wbGVzL2hhaXJf/YmVhY2hfdjM5MTE4/MjY2My9vcmlnaW5h/bC5qcGVn" alt="Image 2" className="circle-image" />
  <img src="https://imgs.search.brave.com/U58TDlsVxPB2204-CjmEZ1A2HSRzoHM0RCaQNkHYKS4/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly90My5m/dGNkbi5uZXQvanBn/LzAyLzUwLzMyLzgy/LzI0MF9GXzI1MDMy/ODI1OF9mZFRsalZJ/QnowV0RWWE5WU3p5/Y01pU3hiUkFISE1j/bS5qcGc" alt="Image 3" className="circle-image" />
  <img src="https://imgs.search.brave.com/IDrRDVlJJZ8QFNpqPcNH6IwtcIzZfJ4JOlfZZtSlwyA/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly90My5m/dGNkbi5uZXQvanBn/LzA4LzM0LzU5LzU2/LzM2MF9GXzgzNDU5/NTYxOF9FczNYeWRp/R2V2SmY3anhWS1pN/QWFLMlF5d0trYXd4/Yi5qcGc" alt="Image 4" className="circle-image" />
  <img src="https://imgs.search.brave.com/Ta3jo15aoBIImdZRh8jTjyeDr63lGXe1DmHPbJvjIpc/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly90My5m/dGNkbi5uZXQvanBn/LzA4LzA3LzYwLzk2/LzM2MF9GXzgwNzYw/OTY0Nl94emlLQ3NU/cTZCakM0bkhvbHV4/d1lRaUVQQ0dGOHAw/US5qcGc" alt="Image 5" className="circle-image" />
</div>
...
<div class="image-list">
  <div class="image-row">
    ...
    <span class="image-name">Alexander <span class="status-dot"></span></span>
  </div>
  <div class="image-row">
    ...
    <span class="image-name">Lorem <span class="time-indicator">2 min</span></span>
  </div>
  <div class="image-row">
    ...
    <span class="image-name">Jiya <span class="status-dot"></span></span>
  </div>
  <div class="image-row">
    ...
    <span class="image-name">Rahul <span class="time-indicator">3 min</span></span>
  </div>
  <div class="image-row">
    ...
    <span class="image-name">Sohail <span class="status-dot"></span></span>
  </div>
  <div class="image-row">
    ...
    <span class="image-name">Vicky <span class="time-indicator">1 min</span></span>
  </div>
  <div class="image-row">
    ...
    <span class="image-name">Ricky <span class="status-dot"></span></span>
  </div>
  <div class="image-row">
    ...
    <span class="image-name">Raj <span class="time-indicator">4 min</span></span>
  </div>
  <div class="image-row">
    ...
    <span class="image-name">Kashish <span class="status-dot"></span></span>
  </div>
  <div class="image-row">
    ...
    <span class="image-name">Nitin <span class="time-indicator">5 min</span></span>
  </div>
</div>
